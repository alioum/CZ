...
(function ($) {
	...
	loadYoumax = function() {	
		...
		$('#youmax').append('<div id="youmax-tabs"><span id="featured_" class="youmax-tab">En avant</span><span id="uploads_" class="youmax-tab">Vidéos</span><span id="playlists_" class="youmax-tab">Playlists</span></div>');

		
		$('#youmax').append('<div id="youmax-encloser"><iframe id="youmax-video" width="'+(youmaxWidgetWidth-2)+'" height="'+(youmaxWidgetWidth/youmax_global_options.youtubeVideoAspectRatio)+'" src="" frameborder="0" allowfullscreen></iframe><div id="youmax-video-list-div"></div><div id="youmax-load-more-div">Afficher plus</div></div>');
	...
	showPlaylists = function(response,loadMoreFlag) {
		...
		$('.youmax-video-tnail-box-2').click(function() {
			//alert(this.id);
			showLoader();
	...
	showUploads = function(response,playlistTitle,loadMoreFlag) {
		...
		if(!loadMoreFlag) {
			...
			if(playlistTitle) {
				...
				$('#youmax-video-list-div').append('<span class="youmax-showing-title youmax-tab-hover" id="uploads_'+response.items[0].snippet.playlistId+'" style="max-width:100%;"><span class="youmax-showing">&nbsp;&nbsp;Playlist: </span>'+playlistTitle+'</span><br/>');
			}
		}
	...
	resetLoadMoreButton = function() {
		...
		$youmaxLoadMoreDiv.text('Afficher plus');
	},
		...
		*/
		...
		$('#youmax-load-more-div').click(function(){
			...
			if(null!=nextPageToken && nextPageToken!="undefined" && nextPageToken!="") {
				...
				$youmaxLoadMoreDiv.html('Toutes les vidéos sont affichées');
			}
