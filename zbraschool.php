              ...
              <!-- Three columns of text below the carousel -->
                <div class="row">
                    <div class="col-lg-4">
                      ...
                      <h2 class="avantage">Patience</h2>
                      <p>Apprendre à son propre rythme</p>
                    ...
                    <div class="col-lg-4">
                      ...
                      <h2 class="avantage">Concentration</h2>
                      <p>Travailler dans les meilleures conditions</p>
                      <p><a role="button" href="#" class="btn btn-default">View details »</a></p>
                    </div><!-- /.col-lg-4 -->
              </div><!-- /.row -->
            </div>
